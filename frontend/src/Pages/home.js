            ...
            <Container>
                ...
                <Grid container justify="center" alignItems="center" style={{marginTop:"3em"}} >
                    ...
                    <Grid xs={12} sm={2} item>
                        <Typography variant="h4" style={{ color: '#20B2AA' }}>Grab the latest fashion items</Typography>
                    </Grid>
                    ...
                    <Grid xs={12} sm={2} item>
                        <Typography variant="h4" style={{ color: '#20B2AA' }}>At affordable prices</Typography>
                    </Grid>
                </Grid>
                <Grid container justify="center" alignItems="center" style={{marginTop:"5em"}} direction="column">
                    <Grid item>
                        <Link to="/login">
                            ...
                            style={{ color: '#20B2AA' }}>Register now</Typography>
                        </Link>
                    </Grid>
                    <Grid item>
